...
urlpatterns = patterns('',
	...
	url(r'^profile/company/create/$', 'Hyperion.apps.hcustomers.views.register_company'),
	url(r'^profile/contact/create/$', 'Hyperion.apps.hcustomers.views.register_contact'),
