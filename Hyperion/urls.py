...
urlpatterns = patterns('',
	...
	url(r'^profile/company/register/$', 'Hyperion.apps.hcustomers.views.register_company'),
	url(r'^profile/contact/register/$', 'Hyperion.apps.hcustomers.views.register_contact'),
